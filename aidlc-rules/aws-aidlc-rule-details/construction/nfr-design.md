...
Present completion message: "NFR Design complete for [unit-name]. Please review `aidlc-docs/construction/[unit-name]/nfr-design/`. You may request changes or approve to continue to [next-stage-name]."
